...
const feature = loadFeature('./src/features/filterEventsByCity.feature'); //requires full path
...
defineFeature(feature, (test) => {
  test('When user hasn’t searched for a city, show upcoming events from all cities.', ({
    ...
    given('user hasn’t searched for any city', () => {}); //nothing needs doing in this
    let AppComponent;
  ...
  test('User should see a list of suggestions when they search for a city.', ({
    ...
    when('user starts typing in the city textbox', async () => {
      ...
      await user.type(citySearchInput, 'Berlin'); //Berlin because you've been using it as default test
    });
